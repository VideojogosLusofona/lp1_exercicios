...
namespace Dog
{
    ...
    class Dog
    {
        ...
        static readonly string[] barks = new string[]
            { "BARK!", "baAAAArk!", "bork!", "BORK!", "Aurf..." };

        /// <summary>
        /// Auto-property will return the chosen dog color, with a private set
        /// </summary>
        public string Color { get; private set; }

        /// <summary>
        /// Auto-property will return the dogs height, with a private set
        /// </summary>
        public double Height { get; private set; }

        /// <summary>
        /// Auto-property will return the dogs weight, with a private set
        /// </summary>
        public double Weight { get; private set; }

        /// <summary>
        /// Property returns the variable satiation and checks if the value
