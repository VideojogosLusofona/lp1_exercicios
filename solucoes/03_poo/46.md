...
### Solução 1
 ...
 - Neste caso corresponde à ultima condição(```else```) que devolve **2 + MetodoRecursivo(4)**
   + **MétodoRecursivo(4)** satisfaz a 2ªcondição(```else if```)que retorna **3 + MétodoRecursivo(3)**
   + **MétodoRecursivo(3)** satisfaz a 3ªcondição(```else```) que retorna **2+MétodoRecursivo(2)**
   + **MétodoRecursivo(2)** satisfaz a 2ª condição e retorna **2+MétodoRecursivo(1)**
   + **MétodoRecursivo(1)** satisfaz a 3ª condição e retorna **3+MétodoRecursivo(0)**
