...
public abstract class Map
{
    ...
    public void AddPlayer(int id, string name, double health, double shield)
    {
        Player newPlayer = new Player(id, name, health, shield);
...
public class Game
{
    internal static int gamesPlayed = 1;
    ...
    internal void GameLoop()
    {
        ...
        Console.WriteLine("Welcome to a simple Map creator!\n");
        ...
        while (run)
        {
            ...
            Console.WriteLine("\t- - -\n");
            Console.WriteLine($"Maps created: {gamesPlayed}.\n");
