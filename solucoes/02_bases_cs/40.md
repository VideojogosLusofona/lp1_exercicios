...
```cs
/// <summary>
/// This method will calculate which player will win by following
/// simple rules: Rock beats Scissors, Scissors beat Paper and 
/// Paper beats Rock.
/// </summary>
/// <param name="player1">Choice of player 1 as an integer</param>
/// <param name="player2">Choice of player 2 as an integer</param>
/// <returns></returns>
static int RockPaperScissors(int player1, int player2)
{
    if (player1 == player2)
